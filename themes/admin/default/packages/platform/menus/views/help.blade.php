	...
	<div class="panel-body collapse" id="help-body">
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 help">
				...
				<h2>{{{ trans('platform/menus::common.title') }}}
					<small>
						<a class="manual" href="{{URL::to('https://cartalyst.com/manual/platform-menus')}}" target="_blank">
				...
				@content('platform-menus-help', 'platform/menus::content/help.md')
