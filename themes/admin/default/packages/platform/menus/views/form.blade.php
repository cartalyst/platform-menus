...
<div class="well well-md hide" {{ empty($child) ? 'data-new-item-form' : 'data-item-form="' . $childId . '"' }}>
	...
	<fieldset>
		...
		<legend>
			{{{ trans("platform/menus::form.child.{$segment}.legend") }}}
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<i class="icon-info-sign" data-toggle="popover" data-content="{{{ trans('platform/menus::form.child.secure_help') }}}"></i>
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="controls">
						<select name="{{ sprintf($childName, 'target') }}" id="{{ $childId }}_target" class="form-control">
		...
		<div class="form-group">
			...
			<input type="text" name="{{ sprintf($childName, 'class') }}" id="{{ $childId }}_class" class="form-control" value="{{ ! empty($child) ? $child->class : null }}">
		</div>
