...
<section id="menus">
	...
	<header class="clearfix">
		...
		<nav class="utilities pull-left">
			<ul>
				<li>
					<a class="btn btn-action" href="{{ URL::toAdmin('menus/create') }}" data-placement="bottom" data-title="{{ trans('button.create') }}"><i class="icon-plus"></i></a>
				</li>
			</ul>
		</nav>
					...
					<tr data-template style="display: none;">
						...
						<td>
							<div class="actions">
								...
								<a class="btn btn-action" href="{{ URL::toAdmin('menus/edit/[[ id ]]') }}" data-title="{{ trans('button.edit') }}"><i class="icon-edit"></i></a>
							</div>
						</td>
					</tr>
